...
CREATE TABLE "item" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"deleted_at" timestamp,
	CONSTRAINT "min_stock_level_check" CHECK ("item"."min_stock_level" > 0)
);
--> statement-breakpoint
...
ALTER TABLE "issue_item" ADD CONSTRAINT "issue_item_item_id_item_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."item"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "purchase_order_items" ADD CONSTRAINT "purchase_order_items_item_id_item_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."item"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "stock" ADD CONSTRAINT "stock_item_id_item_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."item"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "stock_movement" ADD CONSTRAINT "stock_movement_item_id_item_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."item"("id") ON DELETE no action ON UPDATE no action;