  ...
  return (
    <div className="w-full flex flex-col space-y-6 py-6 px-4 md:py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0">
        ...
        <PermissionChecker requiredPermissions={[PERMISSIONS.VENDOR_CREATE]}>
      ...
      {/* Vendors Table */}
      <PermissionChecker requiredPermissions={[PERMISSIONS.VENDOR_READ]}>
                  ...
                  >
                    ...
                    <TableCell className="py-3 text-right">
                      <div className="flex items-center justify-end gap-1 flex-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <PermissionChecker
                          requiredPermissions={[PERMISSIONS.VENDOR_UPDATE]}
                          className="h-8 w-8"
                        >
                          <Button
                            variant="ghost"
                            ...
                            className="h-8 w-8 text-muted-foreground hover:text-foreground"
                            onClick={() =>
                              handleEditVendorButtonClick(vendor.id)
                            }
                          >
                        ...
                        <PermissionChecker
                          requiredPermissions={[PERMISSIONS.VENDOR_DELETE]}
                          className="h-8 w-8"
                        >
                          <WarningDialog
                            id={vendor.id}
