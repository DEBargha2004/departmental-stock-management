              ...
              <FormItem>
                ...
                <FormControl>
                  <PasswordInput
                    ...
                    className={cn(
                      "h-11 bg-background border-border/60 focus:bg-background transition-all font-bold text-sm",
                      "[&>button]:size-8 [&>button]:top-0.5 [&>button]:translate-y-0 [&>button]:right-0.5",
                    )}
                    {...field}
                  />
                </FormControl>
